...
class HostApiPigeon {
  ...
  Future<List<Uint8List>> miFareSendMiFareCommandMultiple({required String handle, required List<Uint8List> commandPackets}) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.nfc_manager.HostApiPigeon.miFareSendMiFareCommandMultiple$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    );
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[handle, commandPackets]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
